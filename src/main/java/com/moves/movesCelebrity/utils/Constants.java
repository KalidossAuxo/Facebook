...
public class Constants {
    ...
    public static final String FACEBOOK_FETCH_ACCOUNT_INSIGHTS = "https://graph.facebook.com/v3.1/%1$s/insights/?metric=page_fan_adds_unique,page_fan_adds&access_token="+ FB_PAGE_ACCESS_TOKEN_EXTENDED;
