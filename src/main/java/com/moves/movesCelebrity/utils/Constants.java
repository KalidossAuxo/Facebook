...
public class Constants {
    ...
    public static final String FB_PAGE_POSTS = FACEBOOK_GRAPH_API_URL + FB_PAGE_ID+"/feed?access_token="+ FB_PAGE_AUTH_EXTENSION;
    public static final String FB_PAGE_POSTS_MEDIA = FACEBOOK_GRAPH_API_URL + FB_PAGE_ID+"/photos?access_token="+ FB_PAGE_AUTH_EXTENSION;
    ...
    //To get an Extended User Access Token
    public static final String FB_USER_ACCESS_TOKEN_EXTENSION = FACEBOOK_GRAPH_API_URL+"/oauth/access_token?client_id=%1$s&client_secret=%2$s&grant_type=fb_exchange_token&fb_exchange_token=%3$s";//{app-id},{app-secret},{short-lived-user-access-token}
}