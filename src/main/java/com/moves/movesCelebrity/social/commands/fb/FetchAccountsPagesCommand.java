...
public class FetchAccountsPagesCommand implements Command<ArrayList<Document>, String> {

    public FetchAccountsPagesCommand() {
    }
    ...
    private ArrayList<Document> fetchFbAccountsPage(String accessToken) {

        ArrayList<Document> posts = null;
        String url = String.format(Constants.FACEBOOK_FETCH_ACCOUNTS_USER_PAGES, accessToken);
